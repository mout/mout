...
describe('number/enforcePrecision()', function() {
    it('should remove unnecessary precision', function() {
        const n = 3.12 * 0.01; // 0.031200000000000002 because of floating point precision error (http://en.wikipedia.org/wiki/Floating_point#Accuracy_problems)
    ...
    it('should fix rounding issues', function() {
        const n = 0.615;
        expect(enforcePrecision(n, 4)).toEqual(0.615);
